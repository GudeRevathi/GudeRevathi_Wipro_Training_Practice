public class ControlledThread_2 extends Thread{
    public void run() {
        for (int i = 1; i <= 3; i++) {
    ...
    public static void main(String[] args) {
        ...
        ControlledThread_2 t1 = new ControlledThread_2();
        ControlledThread_2 t2 = new ControlledThread_2();
        ControlledThread_2 t3 = new ControlledThread_2();
